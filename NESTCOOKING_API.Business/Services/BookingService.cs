...
namespace NESTCOOKING_API.Business.Services
{
    public class BookingService : IBookingService
    {
        ...
        public async Task<RequestBookingDTO> ApprovalBooking(string bookingId, ChefApprovalProcessDTO chefApprovalProcessDTO)
        {
            var exitsBookingRequest = await _bookingRepository.GetAsync(b => b.Id == bookingId);
