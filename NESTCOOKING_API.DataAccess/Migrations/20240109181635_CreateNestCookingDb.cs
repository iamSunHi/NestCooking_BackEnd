...
{
    /// <inheritdoc />
    public partial class CreateNESTCOOKING_APIDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreliminaryTipUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestsToBecomeChef", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequestsToBecomeChef_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Instructor_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_AspNetUsers_ChefId",
                        column: x => x.ChefId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchasedPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchasedPosts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchasedPosts_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CommentHierarchies",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ParrentCommentId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ChildCommentId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentHierarchies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CommentHierarchies_Comments_ChildCommentId",
                        column: x => x.ChildCommentId,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CommentHierarchies_Comments_ParrentCommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentHierarchies_ChildCommentId",
                table: "CommentHierarchies",
                column: "ChildCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommentHierarchies_ParrentCommentId",
                table: "CommentHierarchies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedPosts_PostId",
                table: "PurchasedPosts",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasedPosts_UserId",
                table: "PurchasedPosts",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestsToBecomeChef_UserId",
                table: "RequestsToBecomeChef",
                column: "UserId");
